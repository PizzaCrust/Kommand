...
fun req(vararg permissions: Permission): PermissionRequirement<GuildMessageReceivedEvent> {
...
fun req(vararg roles: Role): PermissionRequirement<GuildMessageReceivedEvent> {
...
fun req(vararg users: Long): PermissionRequirement<GuildMessageReceivedEvent> {
